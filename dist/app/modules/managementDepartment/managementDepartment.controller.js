...
const createManagementDepartment = (0, catchAsync_1.default)(
  async (req, res) => {
    const data = req.body
    const result =
      await managementDepartment_service_1.ManagementDepartmentService.createManagementDepartment(
        data,
      )
...
const getAllManagementDepartment = (0, catchAsync_1.default)(
  async (req, res) => {
    ...
    const result =
      await managementDepartment_service_1.ManagementDepartmentService.getAllManagementDepartment(
        filters,
        paginationOptions,
      )
    ;(0, sendResponse_1.default)(res, {
...
const getSingleManagementDepartment = (0, catchAsync_1.default)(
  async (req, res) => {
    const id = req.params.id
    const result =
      await managementDepartment_service_1.ManagementDepartmentService.getSingleManagementDepartment(
        id,
      )
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateManagementDepartment = (0, catchAsync_1.default)(
  async (req, res) => {
    ...
    const result =
      await managementDepartment_service_1.ManagementDepartmentService.updateManagementDepartment(
        id,
        updatedData,
      )
    ;(0, sendResponse_1.default)(res, {
