...
const getAllFaculty = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await faculty_service_1.FacultyService.getAllFaculty(filters, paginationOptions);
...
const updateFaculty = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await faculty_service_1.FacultyService.updateFaculty(id, updatedData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
