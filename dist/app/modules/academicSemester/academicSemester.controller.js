...
const createAcademicSemester = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicSemester_service_1.AcademicSemesterService.createSemester(academicSemesterData);
...
const getAllSemesters = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicSemester_service_1.AcademicSemesterService.getAllSemesters(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingleSemester = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicSemester_service_1.AcademicSemesterService.getSingleSemester(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'Semesters retrieved successfully!',
...
const updateSemester = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicSemester_service_1.AcademicSemesterService.updateSemester(id, updatedData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteSemester = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params.id;
    const result = await academicSemester_service_1.AcademicSemesterService.deleteSemester(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
